...
import {OntologyTree, OntologyTreeTerm} from '../../wmk/data/OntologyTree';
import {Popup} from '../../wmk/ui/Popup';
import {addTooltip, clearTooltip} from '../../wmk/ui/Tooltip';
import {Widget} from '../../wmk/ui/Widget';
import {dom, DOM} from '../../wmk/util/dom';
import {hasInlineCSS, installInlineCSS} from '../../wmk/util/Theme';
...
export class MetadataWidget extends Widget
{
	...
	constructor(metadata:MixfileMetadatum[], private callbackChange:(metadata:MixfileMetadatum[]) => void)
	{
		...
		if (!hasInlineCSS('metadatawidget')) installInlineCSS('metadatawidget', CSS_METADATAWIDGET);
	}
